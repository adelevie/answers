FactoryGirl.define do
  ...
  factory :guide do
    ...
    content_main  Faker::Lorem.sentences(3).join('. ')
    content_main_extra Faker::Lorem.sentences(2).join('. ')
    content_need_to_know Faker::Lorem.sentence
    content       Faker::Lorem.sentences(5).join('. ')
    preview       Faker::Lorem.sentences(2).join('. ')
    tags          Faker::Lorem.words(33).join(', ')
    contact
    status        "Published"
    type          "Guide"

    factory :default_guide do
