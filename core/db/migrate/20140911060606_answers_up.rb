class AnswersUp < ActiveRecord::Migration
  ...
  def change
    ...
    unless ActiveRecord::Base.connection.table_exists?('answers_answers')
    ...
    unless ActiveRecord::Base.connection.table_exists?('answers_questions')
    ...
    # USERS
    unless ActiveRecord::Base.connection.table_exists?('answers_users')
